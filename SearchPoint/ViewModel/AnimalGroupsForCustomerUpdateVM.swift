//
//  AnimalGroupsForCustomerUpdateVM.swift
//  SearchPoint
//
...
class AnimalGroupsForCustomerUpdateVM {
    ...
    func saveAnimalGroupsForCustomer(dataModel: AnimalGroupsForCustomerUpdateModel ){
        ...
        for data in dataModel.customerGroups {
            ...
            let groupIdGenerate = UserDefaults.standard.integer(forKey: keyValue.groupId.rawValue)
...
extension AnimalGroupsForCustomerUpdateVM : ResponseDelegate {
