    ...
    func saveGetProductData(dataModel: GetProductsModel){
        ...
        for item in dataModel.products {
            ...
            for market in item.markets {
                ...
                let saveObject : [String:Any] = ["isDefault":item.isDefault as Any , "marketsId":market.marketsId as Any ,keyValue.marketName.rawValue:market.marketName as Any ,"productId":item.productID as Any,"provider":item.provider as Any,keyValue.providerIdText.rawValue:item.providerID as Any,"speciesId":item.speciesID as Any,"product":item.product as Any]
            ...
            for addon in item.addOns {
                ...
                if addon.isIncludedInProduct == false{
