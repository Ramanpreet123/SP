...
class ResulyByPageViewModel {
    ...
    private func getParamsforAnimalResult()->[String:Any]{
        let currentCustomerId = UserDefaults.standard.value(forKey: keyValue.currentActiveCustomerId.rawValue) as? Int ?? 0
    ...
    private func getParams()->[String:Any]{
        ...
        let currentCustomerId = UserDefaults.standard.value(forKey: keyValue.currentActiveCustomerId.rawValue) as? Int ?? 0
        let fetchFilterData = fetchResultFilterData1(entityName: Entities.resultFIlterDataSaveTblEntity,customerId: currentCustomerId,isheridity: UserDefaults.standard.bool(forKey: keyValue.isHerditySelected.rawValue))
        ...
        return [keyValue.customerId.rawValue:currentCustomerId,
            ...
            DispatchQueue.main.async {
                ...
                if self.modalObject != nil {
                    ...
                    if self.modalObject?.message == "Okay"
                    {
                        ...
                        let pagenumbervalue = UserDefaults.standard.value(forKey: keyValue.pageNumber.rawValue)
