...
func getOrderedDateStringFrom(date: Date, outputformatter: String) -> String {
    let dateFormatter = DateFormatter()
    dateFormatter.locale = Locale(identifier: LocalizedStrings.en_US_POSIXStr) // set locale to reliable US_POSIX
...
//MARK :- Checking If barcode ending with number and Getting Incremented
func isBarcodeEndingWithNumberAndGetIncremented(_ barcode: String) -> (isBarCodeEndsWithNumber: Bool, incrementedBarCode: String) {
    var digits = ""
