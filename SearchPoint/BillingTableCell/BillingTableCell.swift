...
class BillingCell:UITableViewCell, UITextFieldDelegate{
    ...
    @IBAction func beefPlaceMeSelectionAction(_ sender: UIButton) {
        ...
        if pviduser == 5 &&  UserDefaults.standard.string(forKey: keyValue.beefProduct.rawValue) == keyValue.capsInherit.rawValue{
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        if textField.text != "" {
            ...
            self.dealerCodeView.isUserInteractionEnabled = true
            self.dealerCodeView.alpha = 1
            self.dealerCodeView.backgroundColor = UIColor(displayP3Red: 1, green: 224/255, blue: 203/255, alpha: 1.0)
