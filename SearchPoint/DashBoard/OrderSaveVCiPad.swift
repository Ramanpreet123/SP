//
//  OrderSaveVCiPad.swift
//  SearchPoint
//
//  Created by Ramanpreet Singh on 15/04/25.
//
...
class OrderSaveVCiPad: UIViewController {
...
extension OrderSaveVCiPad : SideMenuUI{
...
extension OrderSaveVCiPad : offlineCustomView{
    func crossBtnCall() {
        buttonbg.removeFromSuperview()
        customPopView.removeFromSuperview()
    }
