...
class OrderSubmittedVC: UIViewController {
    ...
    func setUIOnDidLoad(){
        ...
        if UserDefaults.standard.value(forKey: keyValue.name.rawValue) as? String  == marketNameType.Dairy.rawValue{
            ...
            if UserDefaults.standard.bool(forKey: keyValue.submitBtnFlag.rawValue) {
                submitTiile.text! = NSLocalizedString(keyValue.emailOrder.rawValue, comment: "")
            }
            else {
                submitTiile.text! = NSLocalizedString(LocalizedStrings.orderSubmittedText, comment: "")
            }
        }
        else {
...
extension OrderSubmittedVC : SideMenuUI{
...
extension OrderSubmittedVC : ResponseDelegate {
...
extension OrderSubmittedVC : syncApi {
