...
extension OrderingDefaultsVC :UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    @objc func specisButton(_ sender:UIButton) {
        ...
        if specisObject.speciesName ==  "Dairy" {
              UserDefaults.standard.removeObject(forKey: "BeefPvid")
            marketView.isHidden = false
            primaryBasedOutlet.isHidden = false
            providerTitleLbl.text = NSLocalizedString("Evaluation Provider", comment: "")
            primarlyHeightConst.constant = 146
    ...
    @objc func providerButton(_ sender:UIButton) {
       // UserDefaults.standard.removeObject(forKey: "screen")
        ...
        if UserDefaults.standard.string(forKey: "name") == "Dairy" {
            ...
            if data.count > 0 {
                let alertController = UIAlertController(title: NSLocalizedString("Alert", comment: ""), message: "Changing the product grouping will clear all current order details. Do you want to continue?", preferredStyle: .alert)
...
extension OrderingDefaultsVC : UITableViewDelegate,UITableViewDataSource{
    ...
    @objc func marketTipPop() {
        ...
        //            var yFrame = (marketView.layer.frame.miny) - self.scrollview1.contentOffset.y
        //
        //            var strDeviceType = ""
        //            if UIDevice().userInterfaceIdiom == .phone {
        //                switch UIScreen.main.nativeBounds.height {
        ...
        //                case 1334:
        //                    strDeviceType = "iPhone 6/6S/7/8"
        //                    yFrame = (marketView.layer.frame.minY + 148 - 7 + 3) - self.scrollview1.contentOffset.y
        //                case 1920, 2208:
        //                    strDeviceType = "iPhone 6+/6S+/7+/8+"
        //                case 2436:
        //                    strDeviceType = "iPhone X"
        //                    yFrame = (marketView.layer.frame.minY + 148 + 8) - self.scrollview1.contentOffset.y
        //                case 2688:
        //                    strDeviceType = "iPhone Xs Max"
        //                    yFrame = (marketView.layer.frame.minY + 148 + 20) - self.scrollview1.contentOffset.y
        //                case 1792:
        //                    yFrame = (marketView.layer.frame.minY + 148 + 18) - self.scrollview1.contentOffset.y
        //                    strDeviceType = "iPhone Xr"
        //                default:
        //                    strDeviceType = "unknown"
        //                }
        ...
        customPopView1.elipseImage1.isHidden = true
        customPopView1.textLbl2.isHidden = true
        customPopView1.frame = CGRect(x: 50,y: 450  ,width: screenSize.width - 80, height: 137)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //for Global
        if pvid == 5 {
            if product.productName == "INHERIT"{
