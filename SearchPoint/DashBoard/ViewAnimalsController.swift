...
//MARK: CLASS
class ViewAnimalsController: UIViewController {
    ...
    func setUIOnDidLoad(){
        ...
        noAnimalToast.text = NSLocalizedString(LocalizedStrings.noAnimalAdded, comment: "")
    ...
    func setUIOnWillAppear(){
        ...
        cartLbl.text = NSLocalizedString("Cart", comment: "")
        bckBtnOutlet.setTitle(NSLocalizedString(LocalizedStrings.backBtnText, comment: ""), for: .normal)
        self.continuetoOrderOutlet.setTitle(ButtonTitles.continueProdSelection.localized, for: .normal)
        self.emailOrderOutlet.setTitle("Email Cart".localized, for: .normal)
        self.clearOrderOutlet.setTitle("Clear Cart".localized, for: .normal)
    ...
    @IBAction func backBtnAction(_ sender: UIButton) {
        ...
        if viewAnimalArray.count == 0 {
            ...
            let storyBoard: UIStoryboard = UIStoryboard(name: StoryboardType.MainStoryboard, bundle: nil)
            let newViewController = storyBoard.instantiateViewController(withIdentifier: ClassIdentifiers.orderProductSelectionSecondVC) as! OrderProductSelectionSecondVC
            self.navigationController?.pushViewController(newViewController, animated: false)
        }
        else {
...
extension ViewAnimalsController:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 4 :
            ...
            cell.sampleconLbl.isHidden = false
            ...
            return cell
        case 8:
            let cell:ViewAnimalCell = self.tblView.dequeueReusableCell(withIdentifier: "cartcell") as! ViewAnimalCell
        ...
        default:
            ...
            cell.sampleconLbl.isHidden = true
            cell.barcodeLbl.isHidden = false
            cell.thirdColonLbl.isHidden = false
            cell.barcodeLbl.isHidden = false
            cell.barcodeTtileLbl.isHidden = false
...
private typealias DeleteListHelper = ViewAnimalsController
...
private typealias EmailListHelper = ViewAnimalsController
...
private typealias SyncApiHelper = ViewAnimalsController
...
extension ViewAnimalsController : offlineCustomView {
    func crossBtnCall() {
        buttonbg.removeFromSuperview()
        customPopView.removeFromSuperview()
    }
