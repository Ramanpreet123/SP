    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if UIDevice().userInterfaceIdiom == .pad {
            ...
            if UIDevice.current.orientation.isLandscape {
                ...
                cell.mainTitleLabel.font = cell.mainTitleLabel.font.withSize(25)
                cell.descriptionLabel.font = cell.mainTitleLabel.font.withSize(18)
            }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if UIDevice().userInterfaceIdiom == .pad {
            ...
            //for portrait
                ...
                return CGSize(width: Int(itemWidth) - totalSpacing, height: 260)
            }
                ...
                if Connectivity.isConnectedToInternet() {
                    ...
                    if offSuync  {
                        ...
                        if UserDefaults.standard.value(forKey: keyValue.name.rawValue) as? String  == marketNameType.Dairy.rawValue{
                            ...
                            if UserDefaults.standard.bool(forKey: keyValue.dairySubmitBtnFlag.rawValue) {
...
extension DashboardVC : UITextFieldDelegate {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        //not being used now, needs removal
    }
