...
extension ContactSupportVC :UITableViewDelegate,UITableViewDataSource,MFMailComposeViewControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.cellContentView.layer.borderColor = UIColor.black.cgColor
        ...
        let attrs = [NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue,
                     NSAttributedString.Key.foregroundColor : UIColor.init(red: 29/225, green: 131/225, blue: 174/225, alpha: 1.0)]
        as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any]
        let phoneattrs = [NSAttributedString.Key.foregroundColor : UIColor.init(red: 29/225, green: 131/225, blue: 174/225, alpha: 1.0)]  as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any] as [NSAttributedString.Key : Any]
        ...
        if (contactSupportData.text != nil) && contactSupportData.text != "" {
            ...
            if UIDevice().userInterfaceIdiom == .pad {
                titleAttrs = [NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue,
                              NSAttributedString.Key.foregroundColor : UIColor.init(red: 29/225, green: 131/225, blue: 174/225, alpha: 1.0),NSAttributedString.Key.font: UIFont.systemFont(ofSize: 18)] as [NSAttributedString.Key : Any]
            } else {
                titleAttrs = [NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue,
        ...
        //        if cell.countryBtn.titleLabel?.text == "US" {
        //            cell.flagImgView.image = imagesArray[indexPath.row]
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "UK" {
        //            cell.flagImgView.image = UIImage(named: "UKImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Brazil" {
        //            cell.flagImgView.image = UIImage(named: "BrazilImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Australia" {
        //            cell.flagImgView.image = UIImage(named: "AUSImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "New Zealand" {
        //            cell.flagImgView.image = UIImage(named: "NZImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Canada" {
        //            cell.flagImgView.image = UIImage(named: "CANImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Italy" {
        //            cell.flagImgView.image = UIImage(named: "ItalyImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Netherlands" {
        //            cell.flagImgView.image = UIImage(named: "NETHImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Luxembourg" {
        //            cell.flagImgView.image = UIImage(named: "LUXImage")
        //        }
        //        else if cell.countryBtn.titleLabel?.text == "Belgium" {
        //            cell.flagImgView.image = UIImage(named: "BELImage")
        //        }
