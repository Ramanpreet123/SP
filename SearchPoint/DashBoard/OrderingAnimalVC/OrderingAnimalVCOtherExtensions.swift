//
//  OrderingAnimalVCOtherExtensions.swift
//  SearchPoint
//
...
extension OrderingAnimalVC: scannedOCRProtocol {
...
extension OrderingAnimalVC: QrScannerProtocol {
...
extension OrderingAnimalVC : AnimalMergeProtocol{
    func refreshUI() {
...
private typealias DataListCartHelper = OrderingAnimalVC
...
private typealias AutoImportDataListHelper = OrderingAnimalVC
...
private typealias DeleteListHelper = OrderingAnimalVC
...
extension OrderingAnimalVC:offlineCustomView{
    func crossBtnCall() {
...
//MARK: OFFLINE CUSTOM VIEW
extension OrderingAnimalVC : SideMenuUI,RFID,nearByDevice{
...
extension OrderingAnimalVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell?.bornTypeLabel.numberOfLines = 0
...
extension OrderingAnimalVC : UIImagePickerControllerDelegate & UINavigationControllerDelegate {
...
extension OrderingAnimalVC : offlineCustomView1 {
    func crossBtn() {
