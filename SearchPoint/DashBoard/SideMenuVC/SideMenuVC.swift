    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 4:
            if UIDevice().userInterfaceIdiom == .phone {
                ...
                let imageCount = UserDefaults.standard.value(forKey: keyValue.imageCount.rawValue) as? Int
                if savedImgArr.count != imageCount  {
                    CommonClass.showAlertMessage(self, titleStr:AlertMessagesStrings.alertString.localized + "!", messageStr: AlertMessagesStrings.downloadingAppHelpImages.localized)
                    return
                }
        ...
        case 7:
            ...
            if Connectivity.isConnectedToInternet() {
                ...
                refreshAlert.addAction(UIAlertAction(title:  NSLocalizedString("Ok", comment: ""), style: .default, handler: { (action: UIAlertAction!) in
                    ...
                    self.dataViewModel.logout(modelObj: nil)
