...
extension SettingsVC {
    ...
    @IBAction func actionBtnIKeyBoardnfo(_ sender: UIButton) {
        ...
        customPopView1 = TipPopUp.loadFromNibNamed("TipPopUp") as? TipPopUp
            ...
            if UIDevice().userInterfaceIdiom == .phone {
                ...
                customPopView1.frame = CGRect(x: p.origin.x - 155,y: p.origin.y + 42   ,width: 310, height: 133)
    ...
    @IBAction func marketTipPopClick(_ sender: UIButton) {
        ...
        if UIDevice().userInterfaceIdiom == .phone {
            ...
            let p = sender.convert(sender.bounds,to: self.view)
            customPopView1.frame = CGRect(x: p.origin.x - 175,y: p.origin.y + 42   ,width: 310, height: 150)
    ...
    @IBAction func primarlyBasedTipPopClock(_ sender: UIButton) {
        ...
        if UIDevice().userInterfaceIdiom == .phone {
            ...
            customPopView1.frame = CGRect(x: p.origin.x - 225,y: p.origin.y + 42   ,width: 310, height: 133)
        }
