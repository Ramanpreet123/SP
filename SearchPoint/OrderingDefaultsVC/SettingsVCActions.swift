    ...
    @IBAction func actionBtnIKeyBoardnfo(_ sender: Any) {
        ...
        if langId == 1{
            ...
            if UIDevice().userInterfaceIdiom == .phone {
                ...
                case 768:
                    yFrame = (keyboardTitleView.layer.frame.minY + 770) -  self.scrolView.contentOffset.y
                case 810:
                ...
                case 820:
                    ...
                    if UserDefaults.standard.string(forKey: "name") == marketNameType.Beef.rawValue {
                        ...
                        if pvid == 6 {
                            yFrame = (primarlyBasedView.layer.frame.minY + 460) -  self.scrolView.contentOffset.y
                        } else {
                            yFrame = (primarlyBasedView.layer.frame.minY + 590) -  self.scrolView.contentOffset.y
                        }
                       
                    } else {
                        if self.evaluationProvider == "CLARIFIDE GIROLANDO (BR)" {
                            yFrame = (primarlyBasedView.layer.frame.minY + 460) -  self.scrolView.contentOffset.y
                            
                        } else {
                            yFrame = (primarlyBasedView.layer.frame.minY + 770) -  self.scrolView.contentOffset.y
                        }
                    }
                ...
                case 1024:
                    ...
                    if UserDefaults.standard.string(forKey: "name") == marketNameType.Beef.rawValue {
                        ...
                        if pvid == 6 {
                            ...
                            if self.scannerStackView.isHidden == false {
                                yFrame = (primarlyBasedView.layer.frame.minY + 590) -  self.scrolView.contentOffset.y
                            } else {
                                yFrame = (primarlyBasedView.layer.frame.minY + 460) -  self.scrolView.contentOffset.y
                            }
