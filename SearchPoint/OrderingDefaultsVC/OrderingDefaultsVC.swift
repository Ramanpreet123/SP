...
//    var getEvaluationProvider  = NSArray()
...
//      if UserDefaults.standard.integer(forKey:keyValue.providerID.rawValue ) == 10 && UserDefaults.standard.string(forKey: "name") == "Dairy" {
//
...
//      }
        ...
        if UserDefaults.standard.value(forKey: "name") as? String == "CLARIFIDE CDCB (US)" {
           ...
           // UserDefaults.standard.value(forKey: "name") as? String = "Dairy"
        }
...
//
//                 //   defaultEntryModeOutlet.layer.borderColor = UIColor(red: 117/255, green: 206/255, blue: 222/255, alpha: 1).cgColor
//                //datePickerEntryOutlet.layer.borderColor = UIColor.lightGray.cgColor
//               // defaultEntryModeOutlet.layer.borderWidth = 2
//              //datePickerEntryOutlet.layer.borderWidth = 1
//
//
//            } else {
//
...
//                datePickerEntryOutlet.layer.borderColor = UIColor(red: 117/255, green: 206/255, blue: 222/255, alpha: 1).cgColor
//                defaultEntryModeOutlet.layer.borderColor = UIColor.lightGray.cgColor
//                datePickerEntryOutlet.layer.borderWidth = 2
//                defaultEntryModeOutlet.layer.borderWidth = 1
...
//              let Beefprovider = fetchAray.object(at: 0) as! Saveprovider
//              if Beefprovider.providerId == pvid {
...
//                  deleteRecordFromDatabase(entityName: "OfflineOrderBeef")
                  ...
                  //For Global
                    if productPopupFlag == 0 {
                        ...
                        productPopupFlag = 1
//                        if UserDefaults.standard.value(forKey: "beefProductAdded") as? String == "true" {
//                            calendarViewBkg.isHidden = true
//                            billingView.isHidden = true
//                        } else {
//                            calendarViewBkg.isHidden = false
...
//                    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if providerName == "CLARIFIDE AHDB (UK)"{
            ...
            //  UserDefaults.standard.set(lastValue, forKey: "screen")
        }
        ...
        if screen == "farmid"{
            ...
            //  UserDefaults.standard.set(screen, forKey: "FOReviewOrderVC")
    ...
    @IBAction func ocrInfoPopAction(_ sender: UIButton) {
        ...
        //        buttonbg1.frame = CGRect(x: 0,y: 0,width: screenSize.width,height: screenSize.height)
        //        buttonbg1.addTarget(self, action: #selector(OrderingDefaultsVC.buttonbgPressedTipInof), for: .touchUpInside)
        //        buttonbg1.backgroundColor = UIColor(red: 45/255, green:45/255, blue:45/255, alpha:0.6)
        //        self.view.addSubview(buttonbg1)
        //        self.buttonbg1.addSubview(self.ocrViewShow)
    }
    ...
    @IBAction func rfidAction(_ sender: UIButton) {
        ...
        farmIdBttn.layer.borderWidth = 1
        rfidBttn.layer.borderWidth = 2
        //UserDefaults.standard.set("False", forKey: "isAuSelected")
...
//            customPopView1.elipseImage1.isHidden = true
//            customPopView1.textLbl2.isHidden = true
//            customPopView1.frame = CGRect(x: 53,y: yFrame ,width: screenSize.width - 80, height: 160)
//            customPopView1.textLabel1.text =  NSLocalizedString("This is the genetic evaluation body that will provide your genomic test results. This will be selected by default based upon your market, but may be switched if required to order an evaluation from a different provider. There are restrictions on being able to change this setting.", comment: "")
//
...
//            customPopView1.delegate = self
//            customPopView1.arrow_Top.frame = CGRect(x: marketView.layer .frame.minX - 42, y: -24, width: 26, height: 26)AU
//
//            customPopView1.layer.borderColor = UIColor.blue.cgColor
//            customPopView1.layer.borderWidth = 1
//            customPopView1.layer.cornerRadius = 8
...
//               case 2688,2796:
//                    strDeviceType = "iPhone Xs Max"
//                    yFrame = (primarlyBasedView.layer.frame.minY + 11 + 133 + 3621) -  self.scrolView.contentOffset.y
//
//                case 1792:
//                    yFrame = (primarlyBasedView.layer.frame.minY + 11 + 133 + 36) -  self.scrolView.contentOffset.y
//
//                    strDeviceType = "iPhone Xr"
//                default:
//                    strDeviceType = "unknown"
...
//        }
    ...
    @IBAction func ocrBtnAction(_ sender: Any) {
      ...
      if spName != "Dairy" {
        ...
        //        if BluetoothCentre.shared.smartBowPeripheral?.state == CBPeripheralState.connected {
        //            BluetoothCentre.shared.manager.cancelPeripheralConnection(.smartBowPeripheral)
        //        }
    }
...
extension OrderingDefaultsVC: UICollectionViewDelegate,UICollectionViewDataSource ,UICollectionViewDelegateFlowLayout{
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    if collectionView.tag == 1{
      ...
      //            if langId == 2 {
      //                if data.speciesName == NSLocalizedString("Dairy", comment: "") {
      //                    item.speciesBttn.setTitle("Gado de leite", for: .normal)
      //                } else if data.speciesName == "Beef" {
      //                    item.speciesBttn.setTitle("Gado de corte", for: .normal)
      //                } else if data.speciesName == "Sheep" {
      //                    item.speciesBttn.setTitle("Ovino", for: .normal)
      //                }
      //            } else {
      ...
      if spName == "Dairy" {
        ...
        //                if arrData.providerName == "CLARIFIDE Girolando (BR)"
        //                {
    ...
    if UserDefaults.standard.string(forKey: "name") == "Dairy" {
      ...
      if pviduser != providerObject.providerId {
        ...
        alert.addAction(UIAlertAction(title:  NSLocalizedString("Yes", comment: ""),style: UIAlertAction.Style.default, handler: { (action: UIAlertAction!) in
          ...
          //                UserDefaults.standard.set(providerObject.providerName!, forKey: "providerNameUS")
          //                self.byDefaultProvider = providerObject.providerName!
          if UserDefaults.standard.string(forKey: "providerNameUS") == "CLARIFIDE CDCB (US)" || UserDefaults.standard.string(forKey: "providerNameUS") == "US Dairy Products"{
            self.nominatorHeightConst.constant = 100
          ...
          if providerObject.providerId == 1 ||  providerObject.providerId == 2 || providerObject.providerId == 3 || providerObject.providerId == 8 {
            ...
            //                        if UserDefaults.standard.integer(forKey:keyValue.providerID.rawValue ) == 3{
      ...
      // let data = fetchAllData(entityName: "BeefAnimaladdTbl")
      let providerObjects : GetProviderTbl = (self.getListProvider[sender.tag] as! GetProviderTbl)
      //  self.provideCountCheck.object(at: sender.tag) as! GetProviderTbl
      //      if data.count > 0 {
        ...
        let okAction = UIAlertAction(title: NSLocalizedString("OK", comment: ""), style: UIAlertAction.Style.default) {
          ...
          if UserDefaults.standard.integer(forKey: "BeefPvid") != Int(providerObject.providerId) {
            ...
            if pvid == 5 || pvid ==  13{
              ...
              //                  let bredTy  = breedType[i] as! GetBreedsTbl
              //                  animaltbl1 = animaltbl1.filter { (item) -> Bool in
              //                    if let value = item as? BeefAnimaladdTbl, value.breedId != bredTy.breedId{
              //                      return true
              //                    } else {
              //                      return false
              //                    }
...
//                  self.addBeefProducts()
      ...
      func addBeefProducts() {
       ...
       // let animalData = beefFetchAllDataAnimalDatarderId(entityName: "BeefAnimaladdTbl", userId: userId,orderId:1,orderStatus:"false", pvid: pvid)
  ...
  func updateProviderId() {
    ...
    let animaltbl = fetchAllDataOrderStatus(entityName: "AnimaladdTbl",ordestatus: "false",orderId:orderId,userId:userId) as! [AnimaladdTbl]
     for item in animaltbl {
       // if pvid == 13 then shift eid to unique id and ear tag to visual id
       updateProviderIDAnimal(entityName: "AnimaladdTbl", ordestatus: "false", providerId: pvid, orderId: orderId, userId: userId)
//       deleteDataWithProduct(Int(item.animalId))
//       deleteDataWithSubProduct(Int(item.animalId))
...
//            deleteDataWithListIdDatEntry(entityString: "DataEntryAnimaladdTbl", listId: Int(listID), customerId: UserDefaults.standard.integer(forKey: "currentActiveCustomerId"),userId:self.userID)
//
//            deleteDataWithListId(entityString: "DataEntryList", listId: Int64(listID), customerId: Int(customerId ),userId:self.userID )
          }
