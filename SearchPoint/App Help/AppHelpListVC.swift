...
class AppHelpListVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var appList: UITableView!
    let titleArray = [NSLocalizedString("Dashboard", comment: ""),NSLocalizedString("Menu", comment: ""),NSLocalizedString("Place An Order : Ordering Add Animal(s)", comment: ""),NSLocalizedString("Place An Order : Ordering Defaults", comment: ""),NSLocalizedString("Data Entry Mode", comment: ""),NSLocalizedString("Results", comment: ""),NSLocalizedString("Actions Required", comment: ""),NSLocalizedString("Track Samples", comment: ""),NSLocalizedString("Contact Support", comment: "")]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "AppHelpListCell") as? AppHelpListCell else { return UITableViewCell() }
