...
class SampleTrackingDetailVCiPad: UIViewController {
  ...
  //      sortLbl.text = NSLocalizedString(ButtonTitles.sortByText, comment: "")
    ...
    func setUIOnWillAppear(){
        ...
        self.reportedBttn.layer.borderColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha: 1).cgColor
...
//        resolveIssueHeight.constant = 0
        ...
        sender.backgroundColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha: 1)
