//
//  SampleTrackingDetailVCiPad.swift
//  SearchPoint
//
...
class SampleTrackingDetailVCiPad: UIViewController {
    ...
    //MARK: IB OUTLETS
    @IBOutlet weak var reportedBtnWidth: NSLayoutConstraint!
    @IBOutlet weak var actionRequiredBtnWidth: NSLayoutConstraint!
    @IBOutlet weak var resolveIssuesBtnWidth: NSLayoutConstraint!
    @IBOutlet weak var inProgressBtnWidth: NSLayoutConstraint!
    @IBOutlet weak var allBtnWidth: NSLayoutConstraint!
    ...
    @IBOutlet weak var resolveIssueBttn: UIButton!
    ...
    @IBOutlet weak var actionNeededBttn: UIButton!
    @IBOutlet weak var inProgressBttn: UIButton!
    @IBOutlet weak var reportedBttn: UIButton!
    @IBOutlet weak var allBttn: UIButton!
    ...
    func setUIOnDidLoad(){
        ...
        topViewHeight.constant = 104
        mainViewHeight.constant = 210
        self.setUpFilterStatusButtons(newString: "")
        reportedBttn.backgroundColor = UIColor.white
        reportedBttn.setTitleColor(UIColor.black, for: .normal)
        actionNeededBttn.backgroundColor = UIColor.white
        actionNeededBttn.setTitleColor(UIColor.black, for: .normal)
        inProgressBttn.backgroundColor = UIColor.white
        inProgressBttn.setTitleColor(UIColor.black, for: .normal)
        allBttn.backgroundColor = UIColor(red: 246/255, green: 96/255, blue: 6/255, alpha: 1)
        allBttn.setTitleColor(UIColor.white, for: .normal)
        tblView.reloadData()
        if samples.count == 0 {
            tblView.setMessage("No samples Found")
        } else {
            tblView.setMessage("")
        }
        initialNetworkCheck()
    ...
    func setUIOnWillAppear(){
        ...
        self.reportedBttn.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
    ...
    func setUpLandscapeConstraints(){
        self.buttons = [allBttn, inProgressBttn, resolveIssueBttn, reportedBttn, actionNeededBttn]
        print("Landscape")
        self.reportedBtnWidth.constant = 221
        self.resolveIssuesBtnWidth.constant = 221
        self.actionRequiredBtnWidth.constant = 221
        self.inProgressBtnWidth.constant = 221
        self.allBtnWidth.constant = 221
        self.setButtonFont(fontValue: 20.0, buttons: self.buttons)
    }
     
    func setUpPortraitConstraints(){
        self.buttons = [allBttn, inProgressBttn, resolveIssueBttn, reportedBttn, actionNeededBttn]
        print("Portrait")
        self.reportedBtnWidth.constant = 171
        self.resolveIssuesBtnWidth.constant = 171
        self.actionRequiredBtnWidth.constant = 171
        self.inProgressBtnWidth.constant = 171
        self.allBtnWidth.constant = 171
        self.setButtonFont(fontValue: 17.0, buttons: self.buttons)
    }
    
    func setButtonFont(fontValue : Double, buttons: [UIButton]){
        for button in buttons {
            button.titleLabel?.font = UIFont.systemFont(ofSize: fontValue, weight: .semibold)
        }
    }
    ...
    @IBAction func reportedBtnAction(_ sender: UIButton) {
        ...
        if self.samples.count == 0 {
            ...
            self.tblView.setMessage("No orders found")
        }
        else {
            self.tblView.setMessage("")
        }
        
        sender.setTitle("Reported (\(self.samples.count))", for: .normal)
        sender.backgroundColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1)
        ...
        allBttn.setTitleColor(UIColor.black, for: .normal)
        tblView.reloadData()
    }
    ...
    @IBAction func actionNeededBtnAction(_ sender: UIButton) {
        actionNeddTag = 1
        tagInt = 0
        topViewHeight.constant = 184
        mainViewHeight.constant = 290
    ...
    @IBAction func allinProgressBtnAction(_ sender: UIButton) {
        ...
        sender.backgroundColor = UIColor(red: 246/255, green: 96/255, blue: 6/255, alpha: 1)
        sender.setTitleColor(UIColor.white, for: .normal)
        reportedBttn.backgroundColor = UIColor.white
        reportedBttn.setTitleColor(UIColor.black, for: .normal)
        actionNeededBttn.backgroundColor = UIColor.white
    ...
    @IBAction func sortByDoneAction(_ sender: UIButton) {
        self.sortByView.isHidden = true
        self.backgroundView.isHidden = true
    }
    
    @IBAction func sortByCancelAction(_ sender: UIButton) {
        self.sortByView.isHidden = true
        self.backgroundView.isHidden = true
    }
    ...
    @IBAction func sortByFarmIdAction(_ sender: UIButton) {
        ...
        if self.farmId == 0 {
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: true, sortingKey: keyValue.smallOnFarmId.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
            
        } else {
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: false, sortingKey: keyValue.smallOnFarmId.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
        }
        self.tblView.reloadData()
        self.sortByFarmImgView.image = UIImage(named: "radioSeletedBtn")
        self.sortByOfficialIDImgView.image = UIImage(named: "radioBtn")
    ...
    @IBAction func sortByEarTagAction(_ sender: UIButton) {
        ...
        if self.earTag == 0 {
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: true, sortingKey: keyValue.earTagKey.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
        }
        else{
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: false, sortingKey: keyValue.earTagKey.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
        }
        self.tblView.reloadData()
        self.sortByFarmImgView.image = UIImage(named: "radioBtn")
        self.sortByOfficialIDImgView.image = UIImage(named: "radioBtn")
    ...
    @IBAction func sortByOfficialIdAction(_ sender: UIButton) {
        ...
        if self.animaId == 0 {
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: true, sortingKey: keyValue.capsOfficialId.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
        }
        else{
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: false, sortingKey: keyValue.capsOfficialId.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
        }
        self.tblView.reloadData()
        self.sortByFarmImgView.image = UIImage(named: "radioBtn")
        self.sortByOfficialIDImgView.image = UIImage(named: "radioSeletedBtn")
    ...
    @IBAction func sortByBarcodeAction(_ sender: UIButton) {
        ...
        if self.barCodeId == 0 {
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: true, sortingKey: keyValue.smallSampleBarcode.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
            
        } else {
            self.samples = fetchSamplesWithFilter(entityName: Entities.sampleTblEntity, sampleStatus: self.filterName, sampleStatusId: self.sampleStatusId, ascending: false, sortingKey: keyValue.smallSampleBarcode.rawValue, searchText: self.searchTextField.text ?? "", orderId: self.serverOrderId) as! [Samples]
        }
        self.tblView.reloadData()
        self.sortByFarmImgView.image = UIImage(named: "radioBtn")
        self.sortByOfficialIDImgView.image = UIImage(named: "radioBtn")
...
extension SampleTrackingDetailVCiPad : UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool{
        ...
        if newString != ""{
            ...
            tblView.reloadData()
            if samples.count == 0{
                tblView.setMessage("No Orders Found")
            }
            else {
                tblView.setMessage("")
            }
