...
extension SampleTrackingDetailVCiPad :UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if filterName == LocalizedStrings.reportedFilterName {
            cell.orderIdBttn.backgroundColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1)
            cell.tableInnerview.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
