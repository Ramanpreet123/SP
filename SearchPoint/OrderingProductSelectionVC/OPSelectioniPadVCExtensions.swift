//
//  OPSelectioniPadVCExtensions.swift
//  SearchPoint
//
...
extension OPSelectioniPadVC:offlineCustomView{
    func crossBtnCall() {
...
extension OPSelectioniPadVC : SideMenuUI{
...
extension OPSelectioniPadVC : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
...
//            }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if collectionView.tag == 1{
            ...
            let pid = UserDefaults.standard.integer(forKey: keyValue.pidKey.rawValue)
...
extension OPSelectioniPadVC : UITableViewDelegate, UITableViewDataSource {
...
//                }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == tbblView {
            ...
            let datavale  = sampTypeArr[indexPath.section] as! AnimaladdTbl
            if datavale.farmId != ""{
...
extension OPSelectioniPadVC : offlineCustomView1 {
    func crossBtn() {
    }
}
