...
class InheritBeefVC : UIViewController,UIImagePickerControllerDelegate & UINavigationControllerDelegate,VNDocumentCameraViewControllerDelegate {
    ...
    @IBOutlet weak var sireRegDropdownOutlet: UIButton!
    @IBOutlet weak var damRegDropdownOutlet: UIButton!
    ...
    @IBOutlet weak var inheritBreedBttn: UIButton!
    ...
    @IBOutlet weak var inheritRegAssociationBttn: UIButton!
    ...
    @IBOutlet weak var inheriSireRedOutlet: UIButton!
    ...
    func sideMenuRevealSettingsViewController() -> InheritBeefVC? {
        var viewController: UIViewController? = self
        
        if viewController != nil && viewController is InheritBeefVC {
            return viewController! as? InheritBeefVC
        }
        while (!(viewController is InheritBeefVC) && viewController?.parent != nil) {
            viewController = viewController?.parent
        }
        if viewController is InheritBeefVC {
            return viewController as? InheritBeefVC
        }
        return nil
    }
