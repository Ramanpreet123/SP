//
//  InheritBeefVCActionMethods.swift
//  SearchPoint
//
        ...
        let ok = UIAlertAction(title: NSLocalizedString("Yes", comment: ""), style: .default, handler: { action in
          ...
          //  self.inheritCrossBtnOutlet.isHidden = true
            ...
            if ab == nil || ab == "" {
                ...
                let codeId = fetchBreedDataTissueCode(entityName: Entities.getSampleTblEntity, provId: self.pvid, tissueName: ab!)
...
//                } else {
    ...
    //    droperTableView.frame = CGRect(x: 25,y: yFrame,width: inheriSireRedOutlet.frame.width,height: 200)
    ...
    @IBAction func inheritTissueBttnAction(_ sender: UIButton) {
        ...
        self.sampleTypeView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
        self.setShadowForUIView(view: sampleTypeView, removeShadow: false)
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
                yFrame = (inheritTissueBttn.frame.minY + 585) - self.inheritScrollView.contentOffset.y
    ...
    @IBAction func inheritBreedAction(_ sender: UIButton) {
        ...
        self.breedTypeView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
        self.setShadowForUIView(view: breedTypeView, removeShadow: false)
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
                yFrame = (inheritBreedBttn.frame.minY + 685) - self.inheritScrollView.contentOffset.y
                droperTableView.frame = CGRect(x: 20,y: yFrame,width: 482,height: 150)
    ...
    @IBAction func inheritRegAssociationAction(_ sender: UIButton){
        ...
        self.breedAssociationView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
        self.setShadowForUIView(view: breedAssociationView, removeShadow: false)
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
                yFrame = (inheritRegAssociationBttn.frame.minY + 790) - self.inheritScrollView.contentOffset.y
...
//        }
        ...
        self.setShadowForUIView(view: inheritGenderView, removeShadow: false)
        self.tableViewpop()
        ...
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
                yFrame = (inheritMaleFemaleBttn.frame.minY + 640) - self.inheritScrollView.contentOffset.y
            ...
            case 820:
                if UIScreen.main.nativeBounds.height == 2360.0 {
                    yFrame = (inheritMaleFemaleBttn.frame.minY + 588) - self.inheritScrollView.contentOffset.y
