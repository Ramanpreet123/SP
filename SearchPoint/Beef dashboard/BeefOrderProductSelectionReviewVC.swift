  ...
  var custmerId = UserDefaults.standard.value(forKey: "currentActiveCustomerId") as! Int
    ...
    func selectionObject(check: Bool) {
        ...
        if check == true{
          ...
          if beefPvid == 13 {
              let secondViewController = self.storyboard!.instantiateViewController(withIdentifier: "BeefUSAddAnimalVC") as! BeefUSAddAnimalVC
              self.navigationController!.pushViewController(secondViewController, animated: false)
          }
        } else {
...
//                } else if langId == 2 {
//                    let attributedString = NSMutableAttributedString(string:  "Para obter informações sobre preços de lista de produtos, visite a seguinte página da web. Preços")
//                    cell.pricingTextView.linkTextAttributes = [
//                        .foregroundColor: UIColor.blue,
//                        .underlineStyle: NSUnderlineStyle.single.rawValue
//                    ]
//                    attributedString.addAttribute(.link, value: "1", range: NSRange(location: 90, length: 7))
//                    cell.pricingTextView.attributedText = attributedString
//                  cell.pricingTextView.isHidden = true
//                }
                ...
                var fetchAnimalTbl = fetchBeefSetValueDobCheck(entityName: "BeefAnimaladdTbl",orderId:orderId,userId:userId,customerId:currentCustomerId ?? 0,date:"")
                 ...
                 if fetchAnimalTbl.count == 0 {
                   ...
                   cell.beefEmailMeCheckboxHeightConstraint.constant = 0
                     ...
                     cell.beefEmailMeTopSelectionConstraint.constant = 0 //14
                     cell.beefAggreeTopConstaraint.constant = 0//10
                   cell.beefEmailSelectionOutlet.isHidden = true
                   cell.beefEmaiInfoBtnOutlet.isHidden = true
