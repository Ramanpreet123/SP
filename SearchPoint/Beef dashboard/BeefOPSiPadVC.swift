...
class BeefOPSiPadVC: UIViewController ,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UITableViewDelegate,UITableViewDataSource,UIPopoverPresentationControllerDelegate,offlineCustomView1,UIScrollViewDelegate{
    ...
    @IBOutlet weak var addOnLbl: PaddingLabel!
    ...
    func navigateToAnotherVc(){
        // implementation moved ro another method. needs removal
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.addOnLbl.edgeInset = UIEdgeInsets(top: 5, left: 10, bottom: 5, right: 10)
        self.setSideMenu()
    ...
    @IBAction func reviewOrderAction(_ sender: UIButton) {
        ...
        else
        {
            ...
            let fetchAnimalTbl = fetchBeefSetValueDobCheck(entityName: "BeefAnimaladdTbl",orderId:orderIdBeef,userId:userId1,customerId:currentCustomerId ?? 0,date:"")
