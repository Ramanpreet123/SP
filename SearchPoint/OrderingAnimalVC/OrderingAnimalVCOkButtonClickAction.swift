...
extension OrderingAnimalVC {
    @IBAction func okBtnClickImportView(_ sender: UIButton) {
        ...
        if screenPerference == keyValue.officialId.rawValue {
            ...
            arrayCountCond = fetchAllDataAnimalAnimalTagCheck(entityName: Entities.dataEntryAnimalAddTbl,anmalTag:"",custmerId :UserDefaults.standard.integer(forKey: keyValue.currentActiveCustomerId.rawValue), userID: userId, listId: Int64(listId))
