//
//  OrderingAnimalVCTableViewDelegates.swift
//  SearchPoint
//
...
extension OrderingAnimalVC :UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if btnTag == 10 {
            ...
            let breedidd =  UserDefaults.standard.value(forKey: "breed") as? String
            ...
            if breedidd != breedId {
                ...
                if animalData.count > 0 {
                    ...
                    alert.addAction(UIAlertAction(title: "Yes", style: .default, handler: { (_) in
                        ...
                        let codeId = fetchBreedDatabreedCode( entityName: "GetBreedsTbl",provId: pvid,breedCode:breeedData.alpha2!)
