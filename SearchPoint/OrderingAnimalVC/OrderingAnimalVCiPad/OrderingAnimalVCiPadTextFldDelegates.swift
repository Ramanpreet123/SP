    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if scanAnimalTagText.tag == 0 {
            if textField == farmIdTextField {
                ...
                self.sireIdView.layer.borderColor = UIColor(displayP3Red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
                self.damIdView.layer.borderColor = UIColor(displayP3Red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            ...
            if textField == farmIdTextField {
                self.farmIdView.layer.borderColor = UIColor(displayP3Red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
                self.officalTagView.layer.borderColor = UIColor(displayP3Red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
//                self.farmIdView.layer.shadowColor = UIColor(displayP3Red: 57/255, green: 69/255, blue: 73/255, alpha: 1).withAlphaComponent(1.0).cgColor
//                self.farmIdView.layer.shadowOpacity = 0.7
//                self.farmIdView.layer.shadowOffset = CGSize(width: 0, height: 1)
//                self.farmIdView.layer.shadowRadius = 3
//                self.farmIdView.layer.masksToBounds = false
//                self.officalTagView.layer.shadowOpacity = 0.0
//                self.officalTagView.layer.shadowOffset = CGSize(width: 0, height: 0)
//                self.officalTagView.layer.shadowRadius = 0
                   ...
                   // permanentIDTextField.text = data.offPermanentId
                    ...
                    if data.gender == "Male".localized || data.gender == "M" {
                       // self.male_femaleBtnOutlet.setImage(UIImage(named: NSLocalizedString("LangMale\(langCode)", comment: "")), for: .normal)
                        ...
                        genderString = NSLocalizedString("Male", comment: "")
                        self.male_femaleBtnOutlet.setTitle("Male", for: .normal)
                     //   UserDefaults.standard.set("USDairyGender", forKey: "M")
                        self.male_femaleBtnOutlet.setTitleColor(.black, for: .normal)
                    } else {
                     //   self.male_femaleBtnOutlet.setImage(UIImage(named: NSLocalizedString("LangFemale\(langCode)", comment: "")), for: .normal)
                        genderToggleFlag = 0
                        ...
                        self.male_femaleBtnOutlet.setTitle("Female", for: .normal)
                        self.male_femaleBtnOutlet.setTitleColor(.black, for: .normal)
                  //      UserDefaults.standard.set("USDairyGender", forKey: "F")
                    }
                    let screenRefernce = UserDefaults.standard.value(forKey:keyValue.screen.rawValue) as? String
