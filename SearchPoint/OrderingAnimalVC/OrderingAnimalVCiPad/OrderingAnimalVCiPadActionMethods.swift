...
//        self.sideMenuViewController?.presentRightMenuViewController()
    ...
    @IBAction func breedBtnClick(_ sender: UIButton) {
        ...
        self.breedView.layer.borderColor = UIColor(displayP3Red: 10/255, green: 137/255, blue: 137/255, alpha: 1).cgColor
...
//                importTblView.reloadData()
    ...
    @IBAction func crossedBtnAction(_ sender: Any) {
        ...
        alert.addAction(cancel)
        let ok = UIAlertAction(title: NSLocalizedString("Yes", comment: ""), style: .default, handler: { action in
            var listArray = fetchMergeDataPvidCustomer(entityName: Entities.mergeDataEntryListTblEntity,providerId: Int64(self.pvid),customerId:Int64(self.custmerId ))
