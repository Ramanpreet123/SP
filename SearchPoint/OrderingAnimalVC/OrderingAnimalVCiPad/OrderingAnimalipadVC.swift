...
class OrderingAnimalipadVC : UIViewController,VNDocumentCameraViewControllerDelegate {
    ...
    var dateVale = ""
    var attrs : [NSAttributedString.Key: Any] = [.font: UIFont.systemFont(ofSize: 19), .foregroundColor: UIColor.init(red: 255/225, green: 46/225, blue: 6/225, alpha: 1.0)]
...
//        crossedBtnOutlet.isHidden = true
    ...
    func doDatePicker(){
      ...
      let cancelButton = UIBarButtonItem(title: "Cancel".localized, style: .plain, target: self, action: #selector(self.cancelClick))
        ...
        self.calenderDobView.layer.borderColor = UIColor(displayP3Red: 10/255, green: 137/255, blue: 137/255, alpha: 1).cgColor
    }
    ...
    func setButtonState(button : UIButton?, isOn : Bool) {
        ...
        if isOn {
            button?.backgroundColor = UIColor(red: 255/255, green: 92/255, blue: 2/255, alpha: 1.0)
