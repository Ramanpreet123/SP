...
//        countineanimalbo.isHidden = false
    ...
    @objc func doneClick() {
        ...
        self.calenderDobView.layer.borderColor = UIColor(displayP3Red: 88/255, green: 88/255, blue: 88/255, alpha: 1).cgColor
    ...
    @objc func buttonPreddDroper() {
        self.breedView.layer.borderColor = UIColor(displayP3Red: 88/255, green: 88/255, blue: 88/255, alpha: 1).cgColor
