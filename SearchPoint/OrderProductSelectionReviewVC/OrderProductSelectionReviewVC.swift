...
//
////MARK: CLASS
//class OrderProductSelectionReviewVC: UIViewController {
//    
//    //MARK: OUTLETS
...
//    }
//    
//    //MARK: INITIAL UI SET UP METHODS
//    func setUIOnDidLoad(){
...
//        reviewOrderTitle.text = NSLocalizedString(ButtonTitles.reviewOrderText, comment: "")
...
//            if let value = (selection[i][keyValue.animalId.rawValue]) as? Int, value  == animaltag{
//                selection[i][keyValue.animalId.rawValue] = animaltag
...
//            selection.append ([keyValue.animalId.rawValue:animaltag,"addon":data as Any,"row":index])
//        }
//        reloadTable()
//    }
//    
...
//
//  OrderProductSelectionReviewVC.swift
//  SearchPoint
//
//  Created by "" on 17/10/2019.
//  ""
                ...
                if UserDefaults.standard.value(forKey: "name") as? String  == "Dairy"{
                    ...
                    if UserDefaults.standard.bool(forKey: keyValue.submitBtnFlag.rawValue) == true {
                       ...
                       // cell.emailOrderTopConstraint.constant = 0
                        ...
                        cell.submitOrderOutlet.isHidden = false
                     //   cell.termsHeightConstraint.constant = 59
...
//
//
//         //   UpdateUI(SelectedBillingCustomer: GetBillingContact)
//
//        }
