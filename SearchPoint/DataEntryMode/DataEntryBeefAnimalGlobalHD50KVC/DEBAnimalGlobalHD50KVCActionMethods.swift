//
//  DEBAnimalGlobalHD50KVCActionMethods.swift
//  SearchPoint
//
...
extension DataEntryBeefAnimalGlobalHD50KVC {
    ...
    @IBAction func inheritBtnAction(_ sender: Any) {
        ...
        if !UserDefaults.standard.bool(forKey: keyValue.expandView.rawValue) {
            ...
            inheritScrollView.isScrollEnabled = true
            inheritEidHeightConstraint.constant = 40
            inheritEidBottomConstraint.constant = 20
            inheritSecondaryHeightConstraint.constant = 40
            inheritSecondaryBottomConstraint.constant = 20
            maleFemaleTopConstraint.constant = 14
            maleFemaleHeightConstraint.constant = 56
            inheritRegAssTopConstraint.constant = 20
            inheritRegAssHeightConstraint.constant = 40
            inheritBreedRegNumberTopConstraint.constant = 20
            inheritBreedRegNumberHeightConstraint.constant = 40
            inheritSireRegNumberTopConstraint.constant = 20
            inheritSireRegNumberHeightConstraint.constant = 40
            inheritSireRegAssoTopConstraint.constant = 20
            inheritsireRegAssoHeightConstraint.constant = 40
            inheritSireYearBirthTopConstraint.constant = 20
            inheritSireYearBirthHeightConstraint.constant = 40
            inheritDamIdTopConstraint.constant = 20
            inheritDamIdHeightConstraint.constant = 40
            inheritDamYearBirthTopConstraint.constant = 20
            inheritDamYearBirthHeightConstraint.constant = 40
    ...
    @IBAction func inheritClearFromAction(_ sender: Any) {
        ...
        let ok = UIAlertAction(title:NSLocalizedString("Yes",comment: "") , style: .default, handler: { action in
            ...
            if breed != nil || breed != "" {
                ...
                let inheritBreed = fetchAllDataProductBeefId(entityName: Entities.getBreedsTblEntity, breedName: (self.inheritBreedBttn.titleLabel?.text!)!, productId: 55)
                if inheritBreed.count != 0 {
                    let medbreedRegArr1 = inheritBreed.object(at: 0) as? GetBreedsTbl
                    self.breedId = medbreedRegArr1!.breedId ?? ""
                }
