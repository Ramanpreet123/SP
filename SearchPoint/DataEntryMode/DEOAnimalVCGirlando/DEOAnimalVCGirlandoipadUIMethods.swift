//
//  DEOAnimalVCGirlandoUIMethods.swift
//  SearchPoint
//
...
extension DEOAnimalVCGirlando : UIImagePickerControllerDelegate & UINavigationControllerDelegate {
...
//        tissureDropDown.isHidden = true
        innerScrollViewHeight.constant = 900
        ...
        clearFormBottomConstraint.constant = 180
        addAAnimalStackViewTopConstraint.constant = 50.0
...
//        singleBttn.layer.borderColor = UIColor(red: 117/255, green: 206/255, blue: 222/255, alpha: 1).cgColor
    ...
    func tableViewpop() {
        ...
        buttonbg2.addTarget(self, action:#selector(DEOAnimalVCGirlando.buttonPreddDroper), for: .touchUpInside)
