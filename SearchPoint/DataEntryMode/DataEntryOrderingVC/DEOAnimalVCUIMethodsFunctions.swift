//
//  DEOAnimalVCUIMethodsFunctions.swift
//  SearchPoint
//
...
extension DataEntryOrderingAnimalVC {
    ...
    func setUIOnWillAppear(){
        ...
        addAnimalTtitle.text = NSLocalizedString(ButtonTitles.addAnimalText, comment: "")
        dataEntryReviewData.setTitle(NSLocalizedString(ButtonTitles.reviewDataText, comment: ""), for: .normal)
        appStatusTtitleText.text = NSLocalizedString(ButtonTitles.appStatusText, comment: "")
