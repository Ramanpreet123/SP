//
//  DataEntryBeefViewAnimalController.swift
//  SearchPoint
//
...
// MARK: - CLASS
class DataEntryBeefViewAnimalController: UIViewController {
...
extension DataEntryBeefViewAnimalController:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let pvid = UserDefaults.standard.integer(forKey: keyValue.beefPvid.rawValue)
        if pvid == 5{
            cell.earTagLbl.text = NSLocalizedString(ButtonTitles.earTagText, comment: "")
        ...
        if pvid == 6{
            ...
            cell.rgdTtileBefLabel.text = NSLocalizedString(LocalizedStrings.RGDorAnimalIDText, comment: "")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if UserDefaults.standard.integer(forKey: keyValue.beefPvid.rawValue) == 5  {
            ...
            let vc = storyboard.instantiateViewController(withIdentifier: ClassIdentifiers.dataEntryBeefAnimalGlobalHD50KVC) as! DataEntryBeefAnimalGlobalHD50KVC
            navigationController?.pushViewController(vc,animated: false)
        }
        else if UserDefaults.standard.integer(forKey: keyValue.beefPvid.rawValue) == 6{
            let storyboard = UIStoryboard(name: StoryboardType.MainStoryboard, bundle: nil)
            let vc = storyboard.instantiateViewController(withIdentifier: ClassIdentifiers.dataEntryBeefAnimalBrazilVC) as! DataEntryBeefAnimalBrazilVC
            navigationController?.pushViewController(vc,animated: false)
        }
    }
...
extension DataEntryBeefViewAnimalController {
...
extension DataEntryBeefViewAnimalController : offlineCustomView {
    func crossBtnCall() {
        buttonbg.removeFromSuperview()
        customPopView.removeFromSuperview()
    }
