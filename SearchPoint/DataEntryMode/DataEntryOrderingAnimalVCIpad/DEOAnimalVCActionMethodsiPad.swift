        ...
        if defaltscreen == keyValue.farmId.rawValue {
            if  providerID == 3{
                ...
                if UIDevice().userInterfaceIdiom == .pad {
                    ...
                    case 820:
                        customPopView1.frame = CGRect(x: 598,y: ySize, width: 280, height: 110)
                    ...
                    case 1024:
                        customPopView1.frame = CGRect(x: 678,y: ySize + 45, width: 280, height: 110)

                    case 1032:
                        customPopView1.frame = CGRect(x: 683,y: ySize + 45, width: 280, height: 110)
                ...
                if UIDevice().userInterfaceIdiom == .pad {
                    ...
                    case 1024:
                        customPopView1.frame = CGRect(x: 678,y: ySize + 45, width: 280, height: 90)

                    case 1032:
                        customPopView1.frame = CGRect(x: 683,y: ySize + 45, width: 280, height: 90)
...
//        }
        ...
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
                yFrame = (male_femaleBtnOutlet.frame.minY + 652) - self.scrolView.contentOffset.y
    ...
    @IBAction func sireTipAction(_ sender: UIButton) {
        ...
        var ySize = (innerView.frame.minY + 820) - self.scrolView.contentOffset.y
            ...
            if UIDevice().userInterfaceIdiom == .pad {
                ...
                case 820:
                    ySize = (innerView.frame.minY + 730) - self.scrolView.contentOffset.y
    ...
    @IBAction func tissueBtnClick(_ sender: UIButton) {
        ...
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
                yFrame = (tissueBtnOutlet.frame.minY + 660) - self.scrolView.contentOffset.y
    ...
    @IBAction func breedBtnClick(_ sender: UIButton) {
        ...
        self.breedTypeView.layer.borderColor = UIColor(displayP3Red: 10/255, green: 137/255, blue: 137/255, alpha: 1).cgColor
        if UIDevice().userInterfaceIdiom == .pad {
            switch UIScreen.main.bounds.height {
            case 768:
            ...
            case 820:
                if UIScreen.main.nativeBounds.height == 2360.0 {
                    yFrame = (breedBtnOutlet.frame.minY + 888) - self.scrolView.contentOffset.y
                    if breedArr.count == 2 || breedArr.count == 1{
...
//            tissueDropDownArrow.isHidden = false
            scrollInnerHeightConstraint.constant = 970.0
            ...
            sireIdAndDamIdStackView.isHidden = false
            ...
            clearFormBottomConstraint.constant = 15
            addAnimalStackTopConstraint.constant = 480
