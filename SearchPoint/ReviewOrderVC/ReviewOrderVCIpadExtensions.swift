//
//  ReviewOrderVCIpadExtensions.swift
//  SearchPoint
//
...
extension ReviewOrderVCIpad:offlineCustomView{
    func crossBtnCall() {
...
extension ReviewOrderVCIpad: SideMenuUI{
...
extension ReviewOrderVCIpad :UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == billingTblView {
            let cell = billingTblView.dequeueReusableCell(withIdentifier: "billing", for: indexPath) as? BillingTableViewCell
...
extension ReviewOrderVCIpad : UITextFieldDelegate {
...
extension ReviewOrderVCIpad : objectPickfromConfilict, DismissConflictPopUp{
...
extension ReviewOrderVCIpad : objectPickforcellDelegate {
...
extension ReviewOrderVCIpad : offlineCustomView1 {
    func crossBtn() { }
}

//MARK: OBJECT PICK CART SCREEN EXTENSION
extension ReviewOrderVCIpad : objectPickCartScreen {
