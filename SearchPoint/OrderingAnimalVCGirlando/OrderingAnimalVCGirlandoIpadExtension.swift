...
extension OrderingAnimalVCGirlandoIpad :UITextFieldDelegate  {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        self.setShadowForUIView(view: earTagView, removeShadow: true)
        self.setShadowForUIView(view: breedRegView, removeShadow: true)
        self.setShadowForUIView(view: associationTypeView, removeShadow: true)
        self.setShadowForUIView(view: animalNameView, removeShadow: true)
        self.setShadowForUIView(view: sireRegView, removeShadow: true)
        self.setShadowForUIView(view: damRegView, removeShadow: true)
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if textField == scanEarTagTextField {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.earTagView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: earTagView, removeShadow: false)
            self.setShadowForUIView(view: breedRegView, removeShadow: true)
            self.setShadowForUIView(view: associationTypeView, removeShadow: true)
            self.setShadowForUIView(view: animalNameView, removeShadow: true)
            self.setShadowForUIView(view: sireRegView, removeShadow: true)
        ...
        if textField == breedRegTextfield {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.breedRegView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: earTagView, removeShadow: true)
            self.setShadowForUIView(view: breedRegView, removeShadow: false)
            self.setShadowForUIView(view: associationTypeView, removeShadow: true)
            self.setShadowForUIView(view: animalNameView, removeShadow: true)
            self.setShadowForUIView(view: sireRegView, removeShadow: true)
            self.setShadowForUIView(view: damRegView, removeShadow: true)
        ...
        if textField == girlandoNoTextField {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.associationTypeView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: earTagView, removeShadow: true)
            self.setShadowForUIView(view: breedRegView, removeShadow: true)
            self.setShadowForUIView(view: associationTypeView, removeShadow: false)
            self.setShadowForUIView(view: animalNameView, removeShadow: true)
            self.setShadowForUIView(view: sireRegView, removeShadow: true)
            self.setShadowForUIView(view: damRegView, removeShadow: true)
        }
        ...
        if textField == animalNameTextfield {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.animalNameView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: earTagView, removeShadow: true)
            self.setShadowForUIView(view: breedRegView, removeShadow: true)
            self.setShadowForUIView(view: associationTypeView, removeShadow: true)
            self.setShadowForUIView(view: animalNameView, removeShadow: false)
            self.setShadowForUIView(view: sireRegView, removeShadow: true)
            self.setShadowForUIView(view: damRegView, removeShadow: true)
        }
        ...
        if textField == sireRegTextfield {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.sireRegView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: earTagView, removeShadow: true)
            self.setShadowForUIView(view: breedRegView, removeShadow: true)
            self.setShadowForUIView(view: associationTypeView, removeShadow: true)
            self.setShadowForUIView(view: animalNameView, removeShadow: true)
            self.setShadowForUIView(view: sireRegView, removeShadow: false)
            self.setShadowForUIView(view: damRegView, removeShadow: true)
        }
        ...
        if textField == damRegTextfield {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.damRegView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: earTagView, removeShadow: true)
            self.setShadowForUIView(view: breedRegView, removeShadow: true)
            self.setShadowForUIView(view: associationTypeView, removeShadow: true)
            self.setShadowForUIView(view: animalNameView, removeShadow: true)
            self.setShadowForUIView(view: sireRegView, removeShadow: true)
            self.setShadowForUIView(view: damRegView, removeShadow: false)
        }
