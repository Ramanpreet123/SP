//
//  OrderingAnimalVCGirlandoSelectorUIMethods.swift
//  SearchPoint
//
...
extension OrderingAnimalVCGirlando {
    func setUIOnDidLoad(){
        ...
        let findAttributeString = NSMutableAttributedString(string: NSLocalizedString(LocalizedStrings.findMyAnimalText, comment: ""), attributes: self.attrs)
        importFromListOutlet.setAttributedTitle(attributeString, for: .normal)
        btnFindAnimal.setAttributedTitle(findAttributeString, for: .normal)
    ...
    func tableViewpop() {
        ...
        buttonbg2.addTarget(self, action:#selector(OrderingAnimalVCGirlando.buttonPreddDroper), for: .touchUpInside)
    ...
    func byDefaultSetting(){
        ...
        dateBttnOutlet.layer.borderColor = UIColor.gray.cgColor
        barcodeView.layer.borderColor = UIColor.gray.cgColor
        girlandoNoTextField.layer.borderColor = UIColor.gray.cgColor
