  ...
  //  @IBOutlet weak var sortByButtonOutlet: customButton!
   ...
   // @IBOutlet weak var sortByDownlbl: UILabel!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //TODO: WILL REMOVE THIS temp code
...
//        let sortVC = UIStoryboard(name: "iPad", bundle: nil).instantiateViewController(withIdentifier: "ReviewOrderFilteriPadVC") as! ReviewOrderFilteriPadVC
...
//        dropDown.show()
    ...
    @IBAction func backBtnNavigateToAnimal(_ sender: Any) {
        ...
        if pviduser == 4 {
            var storyboard = UIStoryboard(name: "DataEntryiPad", bundle: Bundle.main)
    ...
    @IBAction func emailMeEnteredDataBtn(_ sender: UIButton) {
        if unchecked {
            unchecked = false
         //   emailMeEnteredBtnOutlet.setImage(UIImage(named: "Incremental_Check"), for: .normal)
            emailCheckImg.image = UIImage(named: "Incremental_Check")
        } else {
            unchecked = true
         //   emailMeEnteredBtnOutlet.setImage(UIImage(named: "incrementalCheckIpad"), for: .normal)
