...
// MARK: - CLASS
class DataEntryInheritBeefVC : UIViewController,UIImagePickerControllerDelegate & UINavigationControllerDelegate,VNDocumentCameraViewControllerDelegate {
    
    
    // MARK: - OUTLETS
    @IBOutlet weak var innerScrollViewHeight: NSLayoutConstraint!
    @IBOutlet weak var addAnimalStackTopConstraint: NSLayoutConstraint!
    @IBOutlet weak var resetBottomConstraint: NSLayoutConstraint!
    @IBOutlet weak var damYOBHeaderView: UIView!
    @IBOutlet weak var damYOBStackView: UIStackView!
    @IBOutlet weak var damIDHeaderView: UIView!
    @IBOutlet weak var sireYOBHeaderView: UIView!
    @IBOutlet weak var sireYOBStackView: UIStackView!
    @IBOutlet weak var sireRegAssociationHeaderView: UIView!
    @IBOutlet weak var sireRegNumberHeaderView: UIView!
    @IBOutlet weak var sireRegStackView: UIView!
    @IBOutlet weak var breedRegHeaderView: UIView!
    @IBOutlet weak var breedAssociationHeaderView: UIView!
    @IBOutlet weak var breedRegStackView: UIStackView!
    @IBOutlet weak var dobHeaderView: UIView!
    @IBOutlet weak var breedTypeHeaderView: UIView!
    @IBOutlet weak var breedAndDobStackView: UIStackView!
    @IBOutlet weak var secondaryHeaderView: UIView!
    @IBOutlet weak var eidHeaderView: UIView!
    @IBOutlet weak var eidAndSecondaryStackView: UIStackView!
    @IBOutlet weak var menuIconLeadingConstraint: NSLayoutConstraint!
    @IBOutlet weak var cartView: UIView!
    @IBOutlet weak var secondaryIDView: UIView!
    @IBOutlet weak var sampleTypeView: UIView!
    @IBOutlet weak var breedTypeView: UIView!
    @IBOutlet weak var breedAssociationView: UIView!
    @IBOutlet weak var breedRegNumberView: UIView!
    @IBOutlet weak var sireRegNumberView: UIView!
    @IBOutlet weak var sireRegAssociationView: UIView!
    @IBOutlet weak var damIDView: UIView!
    @IBOutlet weak var sireYOBView: UIView!
    @IBOutlet weak var damYOBView: UIView!
    ...
    //var autoPopulateAnimalData: Entities.dataEntryBeefAnimalAddTblEntity?
    var autoD = Int()
    var editAid = Int()
    ...
    override func viewDidLayoutSubviews() {
        ...
        let sizeOfContent = height + pos + 270
  ...
  //      incrementalBarcodeCheckBoxGlobal.image = UIImage(named: ImageNames.incrementalCheckImg)
   ...
   //     incrementalBarcodeTitleLabelGlobal.text = NSLocalizedString(ButtonTitles.incrementalBarcodeText, comment: "")
    ...
    func addBtnCondtion(completionHandler: CompletionHandler){
        ...
        if  barcodeflag == true {
            let earTag =  fetchAnimaldataValidateAnimalBarcodeanimalIdOrderIdEarTag(entityName: Entities.dataEntryBeefAnimalAddTblEntity, animalbarCodeTag: scanEarTagTextField.text ?? "", userId: userId, animalId: animalId1,orderSatatus:"false",orderid:orderId)
            //merged
//            if earTag.count > 0 {
...
//        breedRegBttn.layer.borderWidth = 0.5
    ...
    func tableViewpop() {
        ...
        buttonbg2.addTarget(self, action:#selector(DataEntryInheritBeefVC.buttonPreddDroper), for: .touchUpInside)
...
//        tapGestureRecognizer.delegate = self
    ...
    func sideMenuRevealSettingsViewController() -> DataEntryInheritBeefVC? {
        var viewController: UIViewController? = self
        
        if viewController != nil && viewController is DataEntryInheritBeefVC {
            return viewController! as? DataEntryInheritBeefVC
        }
        while (!(viewController is DataEntryInheritBeefVC) && viewController?.parent != nil) {
            viewController = viewController?.parent
        }
        if viewController is DataEntryInheritBeefVC {
            return viewController as? DataEntryInheritBeefVC
        }
        return nil
    }
