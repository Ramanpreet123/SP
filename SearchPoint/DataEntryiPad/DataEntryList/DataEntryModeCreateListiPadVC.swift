    ...
    @IBAction func nextBtnAction(_ sender: Any) {
        ...
        if mergeListContain == true {
            ...
            var _: () = doesListExist(listName:listNameTextField.text ?? "",customerId:Int64(currentCustomerId ?? 0),completionHandler: { (success) -> Void in
                if success == true {
//                    let secondViewController = self.storyboard!.instantiateViewController(withIdentifier: "DataEntryaMergeListIpadVc") as! DataEntryaMergeListIpadVc
...
//                                            let storyBoard: UIStoryboard = UIStoryboard(name: "iPad", bundle: nil)
//                                            let newViewController = storyBoard.instantiateViewController(withIdentifier: "DataEntryModeListiPadVC") as! DataEntryModeListiPadVC
