//
//  DEOAnimalVCExtensionsIpad.swift
//  SearchPoint
//
...
extension DataEntryOrderingAnimalVCIpad :UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.breedTypeView.layer.borderColor = UIColor(displayP3Red: 88/255, green: 88/255, blue: 88/255, alpha: 1).cgColor
...
extension DataEntryOrderingAnimalVCIpad: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension DataEntryOrderingAnimalVCIpad {
    func fetchADHAnimalList(userId: Int, customerID: Int) {
        ...
        let specieID = SpeciesID.dairySpeciesId //UserDefaults.standard.value(forKey:
    ...
    func AutoPopulateSuggetion(tag : Int) {
        ...
        if tag == 0 {
            if scanAnimalTagText.tag == 1{
                ...
                AutoSuggestionTableView.frame = CGRect(x: 20,y: yFrame + 142,width: self.view.frame.width-40,height: 200)
            }
        } else {
            if scanAnimalTagText.tag == 0{
                AutoSuggestionTableView.frame = CGRect(x: 20,y: yFrame + 200,width: self.view.frame.width-40,height: 200)
            } else {
...
extension DataEntryOrderingAnimalVCIpad: QrScannerProtocol {
...
extension DataEntryOrderingAnimalVCIpad: scannedOCRProtocol {
...
extension DataEntryOrderingAnimalVCIpad:offlineCustomView{
    func crossBtnCall() {
...
extension DataEntryOrderingAnimalVCIpad : SideMenuUI,RFID,nearByDevice{
...
extension DataEntryOrderingAnimalVCIpad: UIImagePickerControllerDelegate & UINavigationControllerDelegate {
...
extension DataEntryOrderingAnimalVCIpad: offlineCustomView1 {
    func crossBtn() {
...
extension DataEntryOrderingAnimalVCIpad : objectPickCartScreen {
