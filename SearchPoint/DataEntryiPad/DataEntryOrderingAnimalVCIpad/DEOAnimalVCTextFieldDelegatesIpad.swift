//
//  DEOAnimalVCTextFieldDelegatesIpad.swift
//  SearchPoint
//
...
extension DataEntryOrderingAnimalVCIpad :UITextFieldDelegate  {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if textField == scanAnimalTagText {
            viewsArray = [farmIdView, barcodeView, sireIdView, damIdView]
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.officalTagView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: officalTagView, removeShadow: false)
            self.setShadowForUIView(view: farmIdView, removeShadow: true)
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: sireIdView, removeShadow: true)
            self.setShadowForUIView(view: damIdView, removeShadow: true)
        }
        if textField == farmIdTextField {
            viewsArray = [officalTagView, barcodeView, sireIdView, damIdView]
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.farmIdView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: officalTagView, removeShadow: true)
            self.setShadowForUIView(view: farmIdView, removeShadow: false)
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: sireIdView, removeShadow: true)
            self.setShadowForUIView(view: damIdView, removeShadow: true)
        }
        if textField == scanBarcodeText {
            viewsArray = [officalTagView, farmIdView, sireIdView, damIdView]
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
        ...
        if textField == sireIdTextField {
            viewsArray = [officalTagView, farmIdView, barcodeView, damIdView]
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red:57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            self.sireIdView.layer.borderColor = UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor
            self.setShadowForUIView(view: officalTagView, removeShadow: true)
            self.setShadowForUIView(view: farmIdView, removeShadow: true)
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: sireIdView, removeShadow: false)
            self.setShadowForUIView(view: damIdView, removeShadow: true)
        }
        if textField == damtexfield {
            viewsArray = [officalTagView, farmIdView, barcodeView, sireIdView]
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 57/255, green: 69/255, blue: 73/255, alpha: 1).cgColor)
            ...
            self.setShadowForUIView(view: barcodeView, removeShadow: true)
            self.setShadowForUIView(view: sireIdView, removeShadow: true)
            self.setShadowForUIView(view: damIdView, removeShadow: false)
        }
    }
                ...
                if let char = string.cString(using: String.Encoding.utf8) {
                    ...
                    case 820:
                        if UIScreen.main.nativeBounds.height == 2360 {
                            AutoSuggestionTableView.frame = CGRect(x: 18,y: yFrame + 535 ,width: 565,height: 250)
                        } else {
                            AutoSuggestionTableView.frame = CGRect(x: 18,y: yFrame + 535 ,width: 565,height: 250)
                        }
                    ...
                    case 1032:
                        AutoSuggestionTableView.frame = CGRect(x: 18,y: yFrame + 525 ,width: 655,height: 250)
                    default:
                        AutoSuggestionTableView.frame = CGRect(x: 18,y: yFrame + 525 ,width: 655,height: 250)
                    }
        ...
        if textField == scanAnimalTagText || textField == farmIdTextField {
            if scanAnimalTagText.tag == 0 {
                ...
                if scanAnimalTagText.text != "" {
                    if textField == scanAnimalTagText  {
                        if !borderRedCheck  &&  animalTagValue.count == 17{
                        } else {
                ...
                if animalTagValue != ""{
                    if !borderRedCheck &&  animalTagValue.count == 17 {
                        ...
                        if bbb.count != 0 &&  dataAutoPopulatedBool{
                            ...
                            if bbb.count == 1 &&  !dataAutoPopulatedBool{
                                dataPopulateInFocusChange()
                            }
                        }
                    }
                    ...
                    if animalTagValue.count == 0 && dataAutoPopulatedBool {
