...
extension DataEntryOrderingAnimalVCIpad :UITextFieldDelegate  {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if textField == scanAnimalTagText {
            ...
            self.officalTagView.layer.borderColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha: 1).cgColor
        }
        if textField == farmIdTextField {
            viewsArray = [officalTagView, barcodeView, sireIdView, damIdView]
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 88/255, green: 88/255, blue: 88/255, alpha: 1).cgColor)
            self.farmIdView.layer.borderColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha: 1).cgColor
        }
        ...
        if textField == sireIdTextField {
            ...
            self.changeViewColorToBlack(view: viewsArray, color: UIColor(red: 88/255, green: 88/255, blue: 88/255, alpha: 1).cgColor)
            self.sireIdView.layer.borderColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha: 1).cgColor
        }
        if textField == damtexfield {
