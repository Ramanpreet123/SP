//
//  DataEntryListViewAnimalListiPadVC.swift
//  SearchPoint
//
...
// MARK: - CLASS
class DataEntryListViewAnimalListiPadVC: UIViewController {
   ...
   // @IBOutlet weak var noOrderLbl: UILabel!
    ...
    @IBAction func goToReviewOrderClk(_ sender: UIButton) {
        let storyboard = UIStoryboard(name: "DataEntryiPad", bundle: nil)
        if let viewController = storyboard.instantiateViewController(identifier: "DataEntryReviewDataiPadVC") as? DataEntryReviewDataiPadVC {
...
//            self.navigationController?.pushViewController(newViewController, animated: true)
            ...
            let storyBoard: UIStoryboard = UIStoryboard(name: "DataEntryiPad", bundle: nil)
            let newViewController = storyBoard.instantiateViewController(withIdentifier: "DataEntryReviewDataiPadVC") as! DataEntryReviewDataiPadVC
            self.navigationController?.pushViewController(newViewController, animated: false)
        }
        else if animalBackSave ==  true {
            let storyBoard: UIStoryboard = UIStoryboard(name: "DataEntryiPad", bundle: nil)
            let newViewController = storyBoard.instantiateViewController(withIdentifier: "DataEntryOrderingAnimalVCIpad") as! DataEntryOrderingAnimalVCIpad
            self.navigationController?.pushViewController(newViewController, animated: false)
        }
        else {
...
extension DataEntryListViewAnimalListiPadVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
        ...
        if pviduser == 4 {
            let storyboard = UIStoryboard(name: "DataEntryiPad", bundle: nil)
            let vc = storyboard.instantiateViewController(withIdentifier: "DEOAnimalVCGirlando") as! DEOAnimalVCGirlando
...
extension DataEntryListViewAnimalListiPadVC {
...
extension DataEntryListViewAnimalListiPadVC : offlineCustomView {
    func crossBtnCall() {
        buttonbg.removeFromSuperview()
        customPopView.removeFromSuperview()
    }
