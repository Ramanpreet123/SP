...
extension DEBrazilBeefVCIpad {
    ...
    @IBAction func incrementalBarcodeButtonActionGenotype(_ sender: UIButton) {
        ...
        if UserDefaults.standard.bool(forKey: keyValue.isBarCodeIncremental.rawValue) {
            ...
            sender.isSelected = true
            incrementalBarcodeCheckBoxGenoType.image = UIImage(named: "incrementalCheckIpad")
            UserDefaults.standard.set(true, forKey: keyValue.isBarCodeIncremental.rawValue)
            self.isBarcodeAutoIncrementedEnabled = true
            checkBarcode = false
        }
    ...
    @IBAction func prioorityBreddingAction(_ sender: Any) {
        self.setShadowForUIView(view: genoPrimaryBreedView, removeShadow: false)
        btnTag = 20
        view.endEditing(true)
    ...
    @IBAction func secondayBtnAction(_ sender: Any) {
        self.setShadowForUIView(view: genoSecondaryBreedView, removeShadow: false)
        btnTag = 30
        view.endEditing(true)
    ...
    @IBAction func tertiaryButtonAction(_ sender: Any) {
        self.setShadowForUIView(view: genoTeritiaryBreedView, removeShadow: false)
        btnTag = 50
        view.endEditing(true)
    ...
    @IBAction func clearFromAction(_ sender: Any) {
        ...
        let ok = UIAlertAction(title:NSLocalizedString("Yes",comment: "") , style: .default, handler: { action in
            ...
            if inrementCheck  {
                ...
                self.incrementalBarcodeCheckBoxGenoType.image = UIImage(named: "incrementalCheckIpad")
                UserDefaults.standard.set(true, forKey: keyValue.isBarCodeIncremental.rawValue)
                if UserDefaults.standard.bool(forKey: keyValue.isBarCodeIncremental.rawValue) {
