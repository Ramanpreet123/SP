...
//MARK: CLASS
class MyManagementGroupiPadVC: UIViewController {
    ...
    @IBOutlet weak var createNewGroupOutlet: UIButton!
...
//        self.navigationController?.pushViewController(vc!, animated: true)
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "ResultCreateGroupVCiPad") as? ResultCreateGroupVCiPad
...
//            self.navigationController?.popViewController(animated: false)
//        } else if searchByAnimal {
//          let vc = UIStoryboard.init(name: StoryboardType.MainStoryboard, bundle: Bundle.main).instantiateViewController(withIdentifier: ClassIdentifiers.myHerdResultsByAnimalViewController) as? MyHerdResultsByAnimalViewController
//          self.navigationController?.pushViewController(vc!, animated: false)
//        }
//        else {
//            let vc = UIStoryboard.init(name: StoryboardType.MainStoryboard, bundle: Bundle.main).instantiateViewController(withIdentifier: ClassIdentifiers.myHerdResultsVC) as? MyHerdResultsViewController
//            vc!.bckRetain = true
//            self.navigationController?.pushViewController(vc!, animated: false)
//        }
    }
...
extension MyManagementGroupiPadVC :UITextFieldDelegate {
...
extension MyManagementGroupiPadVC:UITableViewDelegate,UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell : MyManagementGroupCollectionViewCell = self.groupCollectionView.dequeueReusableCell(withReuseIdentifier: "MyManagementGroupCollectionViewCell", for: indexPath as IndexPath) as! MyManagementGroupCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = UIStoryboard.init(name: "Results", bundle: Bundle.main).instantiateViewController(withIdentifier: "GroupDeetailsVCiPad") as? GroupDeetailsVCiPad
...
extension MyManagementGroupiPadVC: UpdateGroupsName {
    func refreshList() {
        self.setUIOnDidLoad()
        self.setUIOnWillAppear()
