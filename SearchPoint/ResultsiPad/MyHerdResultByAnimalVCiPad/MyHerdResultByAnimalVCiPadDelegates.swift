//
//  MyHerdResultByAnimalVCiPadDelegates.swift
//  SearchPoint
//
...
extension MyHerdResultByAnimalVCiPad {
    ...
    func navigateToIndivisualController(productNameStr:String){
        ...
        vc?.getMyHerdArray = dataArray
        vc?.productName = productNameStr
        vc?.searchbyAnimal = true
        vc?.groupStatus = selectedMyHerdArray.status ?? ""
...
extension MyHerdResultByAnimalVCiPad :filterInfoUpdate{
    func cancelPressed() {
...
extension MyHerdResultByAnimalVCiPad : UITextFieldDelegate {
