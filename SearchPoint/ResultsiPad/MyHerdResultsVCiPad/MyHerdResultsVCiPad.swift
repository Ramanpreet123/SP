...
// MARK: - CLASS
class MyHerdResultsVCiPad: UIViewController, VNDocumentCameraViewControllerDelegate{
    ...
    @IBOutlet weak var totalAnimalCount: PaddingLabel!
    ...
    @IBOutlet weak var providerFilterBtnOutlet: UIButton!
    @IBOutlet weak var breedFilterBtnOutlet: UIButton!
    @IBOutlet weak var dateFilterBtnOutlet: UIButton!
    @IBOutlet weak var sexFilterBtnOutlet: UIButton!
    @IBOutlet weak var rfidBtnOutlet: UIButton!
    
    // MARK: - VARIABLES AND CONSTANTS
    var globalCheckId = String()
    ...
    func setUIOnDidLoad(){
        ...
        self.totalAnimalCount.layoutIfNeeded()
        self.totalAnimalCount.layer.masksToBounds = true
        self.totalAnimalCount.edgeInset = UIEdgeInsets(top: 5, left: 10, bottom: 5, right: 10)
    ...
    func navigateToMyherfFilterControler(){
        if Connectivity.isConnectedToInternet(){
            ...
            let vc = storyboard.instantiateViewController(withIdentifier: "MyHerdFilteriPadVC") as! MyHerdFilteriPadVC
            vc.delegate = self
    ...
    func breednameset(){
        ...
        saveResulyByPageViewModel?.myherdresultVC = self
        saveResulyByPageViewModel?.callResultByPageAnimalApi()
    }
...
extension MyHerdResultsVCiPad : swipeCell {
...
extension MyHerdResultsVCiPad : objectPickCartScreen {
...
extension MyHerdResultsVCiPad : UIImagePickerControllerDelegate & UINavigationControllerDelegate {
