...
//MARK: CLASS
class ResultCreateGroupVCiPad: UIViewController,UITextFieldDelegate, UITextViewDelegate {
    
    //MARK: OUTLETS
    @IBOutlet weak var activeImgView: UIImageView!
    @IBOutlet weak var inactiveImgView: UIImageView!
    ...
    var delegateCustom : UpdateGroupsName?
...
//        barnGroupOutlet.setImage(UIImage(named: "radioSeletedBtn"), for: .normal)
//        dollarBtnOutlet.setImage(UIImage(named: "radioBtn"), for: .normal)
...
//        barnGroupOutlet.setImage(UIImage(named: "radioSeletedBtn"), for: .normal)
//        dollarBtnOutlet.setImage(UIImage(named: "radioBtn"), for: .normal)
        dollarImageView.image = UIImage(named: "radioBtn")
        barnIMageView.image = UIImage(named: "radioSeletedBtn")
    }
    
    @IBAction func dollarBtnClick(_ sender: Any) {
        groupTypeName = LocalizedStrings.dollarGroupType
        groupTypeId = 0
//        dollarBtnOutlet.setImage(UIImage(named: "radioSeletedBtn"), for: .normal)
//        barnGroupOutlet.setImage(UIImage(named: "radioBtn"), for: .normal)
        dollarImageView.image = UIImage(named: "radioSeletedBtn")
        barnIMageView.image = UIImage(named: "radioBtn")
    }
    
    @IBAction func activeStatusClick(_ sender: Any) {
        if activeImgView.image == UIImage(named: "radioSeletedBtn") {
            return
        } else {
            groupStatusId = 1
            inactiveImgView.image = UIImage(named: "radioBtn")
            activeImgView.image = UIImage(named: "radioSeletedBtn")
            groupStatusName = LocalizedStrings.activeGroupType
        }
    ...
    @IBAction func inactiveStatusClick(_ sender: Any) {
        if inactiveImgView.image == UIImage(named: "radioSeletedBtn") {
            return
        } else {
            inactiveImgView.image = UIImage(named: "radioSeletedBtn")
            activeImgView.image = UIImage(named: "radioBtn")
            groupStatusId = 0
                ...
                doesGroupExist(groupName: listNameTextField.text ?? "", customerId: Int64(currentCustomerId),completionHandler: { [self] (success) -> Void in
                    if success == true {
                        ...
                        self.createNewGroupResult(customerId: Int64(self.currentCustomerId), groupName: self.listNameTextField.text ?? "", groupTypeId: self.groupTypeId, groupStatusId: self.groupStatusId, description: self.descTextView.text ?? "", completionHandler: { (success) -> Void in
                         ...
                         //   self.sideMenuViewController?.setContentViewController(UINavigationController(rootViewController: storyboard.instantiateViewController(withIdentifier: "MyManagementGroupiPadVC")), animated: true)
...
extension ResultCreateGroupVCiPad:offlineCustomView{
    func crossBtnCall() {
        buttonbg.removeFromSuperview()
        customPopView.removeFromSuperview()
    }
