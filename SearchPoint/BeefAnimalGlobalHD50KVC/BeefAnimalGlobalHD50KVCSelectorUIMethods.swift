...
extension BeefAnimalGlobalHD50KVC {
    ...
    func inheritTextFieldBackroungGrey(){
        ...
        if !isautoPopulated {
            ...
            if UserDefaults.standard.bool(forKey: keyValue.isBarCodeIncremental.rawValue), let lastSavedBarCode = UserDefaults.standard.value(forKey: keyValue.barcodeIncremental.rawValue) as? String {
    ...
    func setUIOnDidLoad(){
        ...
        if UserDefaults.standard.string(forKey: keyValue.beefProduct.rawValue) != keyValue.globalHD50K.rawValue && !isautoPopulated  {
