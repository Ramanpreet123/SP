...
class ApiSync :NSObject {
    ...
    func saveAnimaldata(submitEmailFlag :Bool){
        ...
        Apisync.emailOrder = true
        Apisync.emailAddresses = [email]
    ...
    func saveBeefUSAnimalData(){
        ...
        urlString = Configuration.Dev(packet: ApiKeys.blockYardSubmitOrder.rawValue).getUrl()
