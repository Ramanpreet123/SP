...
class BeefUSAddAnimalVC : UIViewController,offlineCustomView1,/*BarcodeScannerCodeDelegate,BarcodeScannerErrorDelegate,BarcodeScannerDismissalDelegate,*/UIImagePickerControllerDelegate & UINavigationControllerDelegate,VNDocumentCameraViewControllerDelegate {
  func crossBtn() {
...
//      }
    ...
    @IBAction func incrementalBarcodeButtonActionGlobal(_ sender: UIButton) {
        ...
        if UserDefaults.standard.bool(forKey: "isBarCodeIncremental") == true {
            ...
            sender.isSelected = true
            incrementalBarcodeCheckBoxGlobal.image = UIImage(named: "check")
    ...
    override func viewDidLoad() {
        ...
        if animalCount.count == 0{
            ...
            self.defaultIncrementalBarCodeSetting_Inherit()
        inheritBreedArr = fetchproviderProductDataGlobal(entityName: "GetBreedsTbl", provId: pvid, productId: 52, speciesName: "")
...
//        let sizeOfContent = height + pos + 20
    ...
    func inheritByDefaultSetting(){
      ...
      inheritGenderString = "Female".localized
        ...
        if breedId  == "" {
            ...
            var inheritBreed = fetchAllDataProductBeefId(entityName: "GetBreedsTbl", breedName: (inheritBreedBttn.titleLabel?.text!)!, productId: 20)
    ...
    */
    ...
    @IBAction func breedAction(_ sender: UIButton) {
        ...
        breedArr = fetchproviderProductDataGlobal(entityName: "GetBreedsTbl", provId: pvid, productId: 19, speciesName: "")
       ...
       self.view.endEditing(true)
        ...
        let ok = UIAlertAction(title:NSLocalizedString("Yes",comment: "") , style: .default, handler: { action in
            ...
            if inrementCheck == true {
                ...
                self.incrementalBarcodeCheckBoxGlobal.image = UIImage(named: "check")
                UserDefaults.standard.set(true, forKey: "isBarCodeIncremental")
        ...
        let ok = UIAlertAction(title:NSLocalizedString("Yes",comment: "") , style: .default, handler: { action in
          ...
          self.inheritByDefaultSetting()
            ...
            if inrementCheck == true {
                ...
                self.incrementalBarcodeCheckBoxInherit.image = UIImage(named: "check")
                UserDefaults.standard.set(true, forKey: "isBarCodeIncremental")
...
extension BeefUSAddAnimalVC : UITextFieldDelegate{
    ...
    func dataPopulateInFocusChange(){
      ...
      let addAnimal = fetchAnimaldataValidateAnimalwithouOrderID(entityName: "BeefAnimaladdTbl", animalTag:scanEarTagTextField.text!, farmId: "", animalbarCodeTag: scanBarcodeTextfield.text!, offPermanentId: breedRegTextfield.text!, offDamId: damRegTextfield.text!, offsireId: sireRegTextfield.text!,orderId:orderId,userId:userId,custmerId:custmerId ?? 0)
      
      let animalData = fetchAnimaldataValidateAnimalwithouOrderID(entityName: "BeefAnimalMaster", animalTag:scanEarTagTextField.text!, farmId: "", animalbarCodeTag: scanBarcodeTextfield.text!, offPermanentId: breedRegTextfield.text!, offDamId: damRegTextfield.text!, offsireId: sireRegTextfield.text!,orderId:orderId,userId:userId,custmerId:custmerId ?? 0)
      let inheritAnimalData = fetchAnimaldataValidateAnimalwithouOrderID(entityName: "BeefAnimalMaster", animalTag:inheritEarTagTextfield.text!, farmId: "", animalbarCodeTag: inheritBarcodeTextfield.text!, offPermanentId: inheritBreedRegTextfield.text!, offDamId: inheritDamIdTextfield.text!, offsireId: inheritSireRegTextfield.text!,orderId:orderId,userId:userId,custmerId:custmerId ?? 0)
      let inheritAddAnimal = fetchAnimaldataValidateAnimalwithouOrderID(entityName: "BeefAnimaladdTbl", animalTag:inheritEarTagTextfield.text!, farmId: "", animalbarCodeTag: inheritBarcodeTextfield.text!, offPermanentId: inheritBreedRegTextfield.text!, offDamId: inheritDamIdTextfield.text!, offsireId: inheritSireRegTextfield.text!,orderId:orderId,userId:userId,custmerId:custmerId ?? 0)
