////
////  BeefUSAddAnimalVCActionMethods.swift
////  SearchPoint
////
...
//            CommonClass.showAlertMessage(self, titleStr: NSLocalizedString(AlertMessagesStrings.alertString, comment: ""), messageStr: NSLocalizedString(AlertMessagesStrings.enterUniqueId, comment: "") )
//            return
//        }
//        
//        if UserDefaults.standard.bool(forKey: keyValue.isBarCodeMatched.rawValue) == true {
//            sender.isSelected = false
//            incrementalBarcodeCheckBoxInherit.image = UIImage(named: ImageNames.incrementalCheckImg)
//            UserDefaults.standard.set(false, forKey: keyValue.isBarCodeMatched.rawValue)
//            inheritBarcodeTextfield.text = ""
//        } else {
//            sender.isSelected = true
//            incrementalBarcodeCheckBoxInherit.image = UIImage(named: ImageNames.checkImg)
//            UserDefaults.standard.set(true, forKey: keyValue.isBarCodeMatched.rawValue)
...
//        let orderStatus = fetchAllDataWithAnimalIdstatus(entityName: Entities.beefAnimalMasterTblEntity, animalId: idAnimal,orderststus:"true", customerId: self.custmerId)
...
//                UserDefaults.standard.set(self.inheritTissueBttn.titleLabel!.text, forKey: keyValue.beefInheritSampleType.rawValue)
//                let codeId = fetchBreedDataTissueCode(entityName: Entities.getSampleTblEntity, provId: pvid, tissueName: ab!)
//                
//                let naabFetch1 = codeId.value(forKey: keyValue.sampleId.rawValue) as? NSArray
//                if naabFetch1!.count != 0 {
