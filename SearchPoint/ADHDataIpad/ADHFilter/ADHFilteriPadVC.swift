...
class ADHFilteriPadVC: UIViewController{
   ...
   // @IBOutlet weak var lblEndDateTitle: UILabel!
    ...
    func removeAppliedFilters() {
        genderRetain = "F"
        maleBtnOutlet.layer.borderColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha:1.0).cgColor
        allBtnOutlet.layer.borderColor = UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha:1.0).cgColor
        maleBtnOutlet.backgroundColor = UIColor.white
        femaleBtnOutlet.backgroundColor = UIColor(red: 255/255, green: 81/255, blue: 10/255, alpha:1.0)
    ...
    func byDefaultValueSet(){
        if UserDefaults.standard.bool(forKey: keyValue.ADHFilterApplied.rawValue)  == false{
            ...
            if malevale  == "M"{
                maleBtnOutlet.backgroundColor = UIColor(red: 255/255, green: 81/255, blue: 10/255, alpha:1.0)
                ...
                femaleBtnOutlet.layer.backgroundColor = UIColor.white.cgColor
                allBtnOutlet.backgroundColor = UIColor(red: 255/255, green: 81/255, blue: 10/255, alpha:1.0)
