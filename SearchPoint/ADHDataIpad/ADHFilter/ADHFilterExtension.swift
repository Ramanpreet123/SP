...
extension ADHFilteriPadVC: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        ...
        if breedIDArray[indexPath.row] == breedID {
            ...
            cell.breedTitle.backgroundColor = UIColor(red: 255/255, green: 81/255, blue: 10/255, alpha:1.0)
            ...
            cell.breedTitle.layer.borderColor =  UIColor(red: 10/255, green: 137/255, blue: 157/255, alpha:1.0).cgColor
