...
//MARK: CLASS
class GroupDetailsViewController: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate, VNDocumentCameraViewControllerDelegate{
    ...
    func setUIOnWillAppear(){
        ...
        groupDetailTitle.text = ButtonTitles.groupDetailsText.localized
