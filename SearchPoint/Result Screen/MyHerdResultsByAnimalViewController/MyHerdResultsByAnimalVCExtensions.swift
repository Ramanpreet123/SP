...
extension MyHerdResultsByAnimalViewController {
    ...
    //    func AutoPopulateAnimal() {
    //        var yFrame = 460 - self.scrollView.contentOffset.y
    ...
    //
    //            case 1334:
    //                yFrame = 460 - self.scrollView.contentOffset.y
    //
    //            case 1920, 2208:
    //                yFrame = 470 - self.scrollView.contentOffset.y
    //
    //            case 2436:
    //                yFrame = 475 - self.scrollView.contentOffset.y
    //
    //            case 2688,2796:
    //                yFrame = 490 - self.scrollView.contentOffset.y
    //
    //            case 1792:
    //                yFrame = 490 - self.scrollView.contentOffset.y
    //
    ...
    //
    //            case 2778:
    //                yFrame = 500 - self.scrollView.contentOffset.y
    //
    //            default:
    //                yFrame = 400 - self.scrollView.contentOffset.y
    //            }
    //        }
