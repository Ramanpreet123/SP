//
//  MyHerdResultsByAnimalViewController.swift
//  SearchPoint
//
//  Created by Rajni Raswant on 17/08/23.
//
...
//MARK: CLASS
class MyHerdResultsByAnimalViewController: UIViewController,swipeCell,VNDocumentCameraViewControllerDelegate{
    ...
    @objc private func handleLongPress(sender: UILongPressGestureRecognizer) {
        if sender.state == .began {
            ...
            if let indexPath = tblView.indexPathForRow(at: touchPoint) {
                let cell = self.tblView.cellForRow(at: indexPath) as! MyHerdTblCell
    ...
    func checkSelectedCell(){
        ...
        if filterHerdanimal.count>0 {
            ...
            deletAnimalHeightConstraint.constant = 40
        } else {
            deleteAnimalStackView.isHidden = true
            deletAnimalHeightConstraint.constant = 0
        }
